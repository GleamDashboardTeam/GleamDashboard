...
summary (paramDataAll.dt[ Animal == "Chickens" & varName == "AFKG"])
...
paramDataAll.dt [ Animal == "Chickens" & varName == "LW"]
...
dmRaw.dt[Animal %in% c("Pigs", "Chickens"), AnimalGroup:= "Monogastrics"]
...
#junk <- allData.dt[ Element == "CH4" & VarName == "Emissions" & Animal %in% c("Pigs", "Chickens")  , sum (V1 * GWP/1000) /1e6,by= .(Animal, Item, LPS)]

#allData.dt[ Element == "CH4" & VarName == "Emissions" & Animal %in% c("Pigs", "Chickens")  , sum (V1 * GWP/1000) /1e6, by= "Item"]
#allData.dt[ Element == "N2O" & VarName == "Emissions" & Animal %in% c("Pigs", "Chickens")  , sum (V1 * GWP/1000) /1e6,by= .(Animal, LPS)]
...
#Animal <- c("Cattle", "Buffalo", "Goats", "Sheep", "Pigs", "Chickens", "Chickens","Cattle", "Buffalo", "Goats", "Sheep" )
